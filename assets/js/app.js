document.addEventListener('DOMContentLoaded', (e) => {
    ...
    dataFirma.addEventListener('submit', (e) => {
        ...
        firma.innerHTML = `
        <div  style="display:inline-block; min-height:130px; vertical-align:middle; width:550px;">
                        
        <!-- imagen -->
        <a  style="display: inline; color:white; font-weight: bold; text-decoration: none; vertical-align: middle;" href="https://www.utp.edu.co">
        ...
        <div style="display:inline-block;vertical-align:middle">
            <div style="color:black; display:table-cell; font-family:Helvetica;font-size:14px; height: 120px;line-height: 18px; padding-left:15px; vertical-align: middle; width:380px">
                ...
                <div style="font-family:Helvetica">
                    ...
                    <div>
                        <a style="color:#003d6d" class="enlace-institucional" href="mailto:${ dataFirma.elements[6].value }" target="_blank"> admweb@utp.edu.co </a>
                    </div>
                </div>
            </div>
        </div>
    ...
    >
        ...
        <div style="display: inline-block; height: 22px; margin-top: 5px; vertical-align: middle;">
            ...
            <!-- Web -->
            <a target="_blank" style="display:inline-block; color:white; height: 32px; margin-right: 10px; vertical-align: middle;" href="https://www.utp.edu.co">
                <img width="20" height="20" title="ir a la web" src="https://media2.utp.edu.co/iconos/sociales/WebB.png" alt="icono web" >
            </a>
            
            
            <!-- redes -->
            <a target="_blank" style="display:inline-block; color:white; height: 32px; margin-right: 10px; vertical-align: middle; " href="https://facebook.com/utpereira"> 
                <img width="20" height="20" title="ir a facebook" src="https://media2.utp.edu.co/iconos/sociales/FacebookB.png" alt="icono facebook">
            </a>
            <a target="_blank" style="display:inline-block; color:white; height: 32px; margin-right: 10px; vertical-align: middle;" href="https://twitter.com/utpereira">
                <img width="20" height="20" title="ir a twitter" src="https://media2.utp.edu.co/iconos/sociales/TwitterB.png" alt="icono twitter">
            </a>
            <a target="_blank" style="display:inline-block; color:white; height: 32px; margin-right: 10px; vertical-align: middle;" href="https://youtube.com/utpereira">
                <img width="20" height="20" title="ir a youtube" src="https://media2.utp.edu.co/iconos/sociales/YoutubeB.png" alt="icono youtube">
            </a>
            <a target="_blank" style="display:inline-block; color:white; height: 32px; margin-right: 10px; vertical-align: middle;" href="https://instagram.com/utpereira">
            ...
            <a target="_blank" style="display:inline-block; color:white; height: 32px; margin-right: 40px; vertical-align: middle;" href="https://www.linkedin.com/school/universidad-tecnol-gica-de-pereira/">
            ...
            <div style="display: inline-block; height: 18px; margin-top: 5px; vertical-align: middle;">
                ...
                <span style="display: inline-block; height: 32px; margin-left: 10px;">
                    +57 606 3137300
                </span>
            ...
            <div style="display: inline-block; height: 19px; margin-top: 5px; vertical-align: middle;">
                ...
                <span style="display: inline-block; font-weight: bold; height: 32px; margin-left: 40px;">
                    @UTPereira
                </span>
